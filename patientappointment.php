                        ...
                        <div class="col-lg-7">
                            ...
                            <li class="col-sm-6">
                                ...
                                <?php 
                                    if(isset($_SESSION['patientid']))
                                    {
                                        echo'<input readonly type="text" class="select6 form-control" id="select6" class="selectpicker" name="" id="" value="'.$rspatient['gender'].'">';
                                       //echo $rspatient['gender'];
                                       if($rspatient['gender']=="MALE") echo'<i class="ion-male"></i>';
                                       else if($rspatient['gender']=="Female") echo'<i class="ion-female"></i>';
                                       else echo'<i class="ion-transgender"></i>';
