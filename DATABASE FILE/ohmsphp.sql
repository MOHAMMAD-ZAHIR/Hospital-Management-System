...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2022 at 02:17 PM
...
(17102016, 'Zahir', 'zahir14', '123456789', 'Active', ''),
(17102017, 'Rohim', 'rohim22', 'rohim2022', 'Active', '');
...
(6, '', 4, 0, 1, '2022-08-17', '16:45:00', 1, 'Approved', 'help me!!!!!!!!'),
(7, '', 7, 0, 3, '2022-08-17', '17:20:00', 4, 'Approved', 'help me dr!'),
(8, '', 8, 0, 1, '2022-08-20', '22:00:00', 1, 'Approved', 'I have an eating disorder.'),
(9, '', 8, 0, 1, '2022-08-20', '10:10:00', 1, 'Active', 'gastric'),
(10, '', 7, 0, 6, '2022-08-20', '22:30:00', 8, 'Active', 'I can feel pain in my two lateral side .'),
(11, '', 8, 0, 3, '2022-08-20', '20:33:00', 4, 'Approved', 'Abortion'),
(12, '', 8, 0, 3, '2022-08-25', '14:00:00', 4, 'Approved', 'Abortion');
...
(6, 7, 7, '2022-08-16', '14:04:04', 5.00, 0.00, 'amin , ', '02:04:50', '2022-08-16'),
(7, 4, 6, '2022-08-16', '14:18:06', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(8, 8, 8, '2022-08-16', '14:24:29', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(9, 8, 11, '2022-08-16', '16:35:12', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(10, 7, 10, '2022-08-16', '17:12:14', 0.00, 0.00, '', '00:00:00', '0000-00-00'),
(11, 8, 12, '2022-08-17', '06:22:38', 0.00, 0.00, '', '00:00:00', '0000-00-00');
...
(6, 4, 5, 'Consultancy Charge', 9.00, '2021-06-24', 'Active'),
...
(12, 6, 4, 'Consultancy Charge', 155.00, '2022-08-16', 'Active'),
(13, 6, 32, 'Treatment', 520.00, '2022-08-16', 'Active'),
(14, 9, 4, 'Consultancy Charge', 200.00, '2022-08-16', 'Active'),
(15, 9, 30, 'Treatment', 560.00, '2022-08-16', 'Active'),
(16, 9, 5, 'Prescription Charge', 9.00, '2022-08-16', 'Active'),
(17, 10, 4, 'Consultancy Charge', 4.00, '2022-08-16', 'Active'),
(18, 10, 35, 'Treatment', 2000.00, '2022-08-16', 'Active'),
(19, 10, 6, 'Prescription Charge', 0.00, '2022-08-17', 'Active'),
(20, 10, 27, 'Treatment', 25448.00, '2022-08-17', 'Active');
...
(10, 'Sexology', 'We are offering sexual health and semen text.', 'Active');
...
(4, 'Arfan Talukder', '7025558690', 3, 'arfan', 'password', 'Active', 'MD', 4.0, 4.00),
...
(9, 'Urmi', '0159999999', 3, 'urmi1', 'password', 'Active', 'MBBS', 10.0, 1000.00);
...
(36, 4, '16:00:00', '22:00:00', '', 'Active'),
(37, 4, '22:00:00', '23:00:00', '', 'Active');
...
(3, 'Miconazole', 27.00, 'Prescribed for various skin infections such as jockitch and also for vaginal yeast infections', 'Active'),
...
(7, 'Arfan', '2022-08-14', '09:17:32', 'JKKNIU', '01521548973', 'Trishal', '2230', 'arfan46', '11112222', 'A+', 'MALE', '2000-02-02', 'Active'),
(8, 'Ikiryo', '2022-08-16', '14:08:55', 'Mymensingh', '01778394305', 'Mymensingh', '2200', 'ikiryo', 'ikiryo2022', 'A+', 'MALE', '2018-01-01', 'Active');
...
(4, 7, 7, '2022-08-16', '14:05:12', 703.75, 'Active', '', 0, 0, '0000-00-00');
...
(4, 0, 4, 8, '', 0, '2022-08-16', 'Active', 11),
(5, 0, 4, 8, '', 0, '2022-08-16', 'Active', 11),
(6, 0, 4, 7, '', 0, '2022-08-18', 'Active', 10);
...
(34, 'One stop service', '1000.00', 'Abortion service', 'Active'),
(35, 'Semen Test', '2000.00', 'Rapid test', 'Active'),
(36, 'Fever Test', '100.00', 'Fast service', 'Active');
...
(5, 32, 7, 7, 4, 'You have to take a glass of water daily.', '7058967162. SSC_Bangla 2 2023.pdf', '2022-08-16', '11:07:00', 'Active'),
(6, 30, 11, 8, 4, 'Precheck of the patient.', '851663455', '2022-08-16', '20:38:00', 'Active'),
(8, 27, 10, 7, 4, 'JKKNIU', '1097574779', '2022-08-17', '07:58:00', 'Active');
...
--
ALTER TABLE `admin`
  MODIFY `adminid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17102018;
...
--
ALTER TABLE `billing`
  MODIFY `billingid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `billing_records`
--
ALTER TABLE `billing_records`
  MODIFY `billingservice_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `doctor_timings`
  MODIFY `doctor_timings_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `treatment`
  MODIFY `treatmentid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `treatment_records`
--
ALTER TABLE `treatment_records`
  MODIFY `treatment_records_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
